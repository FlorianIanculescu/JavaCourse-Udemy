...
//        TodoItem  item2 = new TodoItem("Doctor's Apointment", "See Dr. Smith at 123 Main Street", LocalDate.of(2016, Month.MAY, 23));
...
//        TodoItem  item5 = new TodoItem("Pickup dry cleaning", "The clothes should be ready by Wednesday", LocalDate.of(2016, Month.APRIL, 20));
//
//        todoItems = new ArrayList<>();
//        todoItems.addAll(List.of(item1, item2, item3, item4, item5));
//
...
//        itemDetailsTextArea.setText(sb.toString());
    ...
    public void deleteItem(TodoItem item) {
        ...
        alert.setContentText("Are you sure? Press OK to conform, or cancel to Back out.");
